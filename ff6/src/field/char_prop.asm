...
; 11: gau
        ...
        ; ot6: Gau gets Fight.  Vanilla's four slots were RAGE/LEAP/
        ;   MAGIC/ITEM, with no Fight at all, which was workable while Rage
        ;   was free and is not now that it costs 8 MP: an out-of-MP Gau
        ;   had no action at all.  There is no spare slot (vanilla's "blank"
        ...
        ;   sacrificed: this record is the off-Veldt layout and does not
        ;   change; the sharing is a runtime decision, never a rewrite of
        ;   the save.
