...
H.run({ maxFrames = 60000 }, {
  ...
  H.navTo(3, 6, { maxFrames = 12000, playBattles = "flee", careThreshold = 0.85, healPercent = 45 }),
  tapInto("up", function() return map() == 270 end, 9000,
    "door 264 (3,5) -> map 270 (the save room)"),
  H.waitFrames(60),
  H.navTo(25, 11, { maxFrames = 12000, playBattles = "flee", careThreshold = 0.85, healPercent = 45 }),
  ...
  --    turns the party.
  H.navTo(3, 7, { maxFrames = 24000, playBattles = "flee", careThreshold = 0.85, healPercent = 45 }),
