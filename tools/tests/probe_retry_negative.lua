...
-- a CONTRACT failure must fail on attempt 1 of 3 with no replay.  Run it by
-- hand; the expected outcome is a FAIL (run.sh exit 1) whose log carries
