-- probe_moogle_evpc.lua -- TRACE the event PC through a wave-1 loss
...
-- event commands park the PC for many frames, so the parked addresses name
-- exactly which script bytes the loss path actually executes.  Zero
