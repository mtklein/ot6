...
STATES = [
    ...
    #
    #   whelk_entry  -> gen_arvis          -> arvis_wake
    #                   -> gen_narshe_escape  -> narshe_streets
    #                   -> gen_mines_chase    -> moogle_entry
    ...
    # Mt. Kolts trash pool need this one, not kolts_entry.
    S("kolts_pool", gen="gen_kolts_pool", prev="kolts_entry"),
    ...
    # gen_opera1_entry: zozo_done -> the world -> JIDOOR -> its north BUMP
    ...
    S("opera_entry", gen="gen_opera1_entry", prev="zozo_done"),
    ...
    S("opera_open", gen="gen_opera2_open", prev="opera_entry"),
    ...
    # timeout=1800: the catwalk crossing banks its first standing arrival
    # on the clock, but behind it is a six-rung fallback ladder and each
    # rung can spend the chase's whole 18000-frame clock.
    ...
    # gen_ifrit_entry: the {37,44} chute -> map 264 {10,7} -> parked at
    # {3,7} facing IFRIT, one A-press from battle 70.
    S("ifrit_entry", gen="gen_ifrit_entry", prev="mrf_kefka"),
