...
-- fact (clear $007A, the airship-dead switch the post-crash section plans
-- around), and assert the exit contract.  The expected outcome is a failure
-- naming the switch.  Not a suite test; run by hand, expect exit 1.
