...
H.run({ maxFrames = 12000 }, {
  ...
  (function()
    ...
    return H.driveUntil(function()
      ...
      H.call(function()
        hb = hb + 1
        -- SUPPRESS random encounters: keep the danger accumulator at 0 so the
        -- roll never overflows into RandBattle (which HANGS on this z-split
        -- beam's ambiguous-z scroll_obj -- measured, probe_climb_live).
