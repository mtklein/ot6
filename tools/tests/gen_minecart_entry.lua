...
H.run({ maxFrames = 60000 }, {
  ...
  H.navTo(4, 55, { maxFrames = 9000, playBattles = "flee", careThreshold = 0.85, healPercent = 45, magic = { [6] = { spell = 2 } } }),
  ...
  H.navTo(function() return cid[1] end, function() return cid[2] end,
    { maxFrames = 9000, playBattles = "flee", careThreshold = 0.85, healPercent = 45, magic = { [6] = { spell = 2 } } }),   -- beside CID
  (function() local calm = 0
    return H.driveUntil(function()
