...
-- knew a spell, so before Zozo every non-caster showed no MP while Steal and
...
--
-- Fixture: sfigaro_passage, LOCKE solo (occupied South Figaro), with no
-- spells known and no espers owned, which is the case the owner reported,
-- and with his save MP unmodified.
--
...
-- 10 of successive rows, per menu_text_en.inc CHAR_BLOCK_1_*):
