...
-- fight gets. Replays the stations plan and then instruments the Marshal
-- fight: party HP and monster HP (battle HP table slots 4..9) every 240
-- frames. Also dumps the party's item inventory at defense-live. The
-- battle driver presses R once per ~half-second and A three times.
-- Zero writes.
...
-- Runs until the battle module is gone and stays gone for 240 frames.
