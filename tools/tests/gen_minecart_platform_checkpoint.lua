...
-- tools/tests/savestate_graph.py): boot minecart_entry
...
-- See gen_mrf_save_room_checkpoint.lua for the two measured hazards
-- (save-tile control flicker; codex witness seeding) this file's shape
-- inherits.
