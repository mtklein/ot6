...
H.run({ maxFrames = 60000 }, {
  ...
  H.openChest{ stand = { 7, 45 }, face = "up", bit = 84,
               what = "X-Potion", nav = { playBattles = "flee", careThreshold = 0.85, healPercent = 45 } },
  ...
  H.openChest{ stand = { 25, 45 }, face = "up", bit = 87,
               what = "ThunderBlade", nav = { playBattles = "flee", careThreshold = 0.85, healPercent = 45 } },
  H.openChest{ stand = { 24, 52 }, face = "right", bit = 85,
               what = "Remedy", item = 0xF5, nav = { playBattles = "flee", careThreshold = 0.85, healPercent = 45 } },
  ...
  H.navTo(22, 52, { maxFrames = 18000, playBattles = "flee", careThreshold = 0.85, healPercent = 45 }), -- transition
