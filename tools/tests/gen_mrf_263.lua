-- gen_mrf_263.lua -- mrf_chute (MAGITEK FACTORY map 262, {10,45}) -> the
-- right conveyor at {11,45} -> {20,45} -> the scripted transition at
-- {22,53} -> map 263, the factory's lower floor.  Generates mrf_263.mss.
--
-- The {11,45} trigger is ungated and moves the party RIGHT to {20,45}.
-- The {22,53} trigger loads map 263 and walks the party to {22,18}.
...
H.run({ maxFrames = 60000 }, {
  ...
  H.openChest{ stand = { 7, 45 }, face = "up", bit = 84,
               what = "X-Potion", nav = { playBattles = "tactical", careThreshold = 0.85, healPercent = 45, magic = { [6] = { spell = 2 } }, summon = { [6] = {} } } },
  ...
  H.openChest{ stand = { 25, 45 }, face = "up", bit = 87,
               what = "ThunderBlade", nav = { playBattles = "tactical", careThreshold = 0.85, healPercent = 45, magic = { [6] = { spell = 2 } }, summon = { [6] = {} } } },
  H.openChest{ stand = { 24, 52 }, face = "right", bit = 85,
               what = "Remedy", item = 0xF5, nav = { playBattles = "tactical", careThreshold = 0.85, healPercent = 45, magic = { [6] = { spell = 2 } }, summon = { [6] = {} } } },

  -- 2. across to {22,52} and one tapped DOWN onto {22,53} -> map 263
  H.navTo(22, 52, { maxFrames = 40000, playBattles = "tactical",
    careThreshold = 0.85, healPercent = 45,
    magic = { [6] = { spell = 2 } }, summon = { [6] = {} },
    arrive = function() return map() == 263 end }),
  H.navTo(22, 52, { maxFrames = 18000, playBattles = "tactical", careThreshold = 0.85, healPercent = 45, magic = { [6] = { spell = 2 } }, summon = { [6] = {} } }), -- transition
