...
JOBS="${OT6_JOBS:-4}"
TESTS="smoke school battle_entry battle_break battle_reveal battle_reveal_poweron battle_class battle_bp battle_boost battle_bushido probe_bushidobusy battle_runic battle_hits battle_fold battle_preview battle_codex battle_c battle_fontrestore battle_banner battle_dlgmenu battle_whelkwipe battle_dmgnum battle_lateboost probe_shadow_overlap hud_stability visual_f1 visual_f2"
