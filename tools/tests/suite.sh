...
for t in smoke battle_entry battle_break battle_bp battle_boost battle_hits battle_fold battle_preview battle_codex battle_c hud_stability visual_f1 visual_f2; do
