...
JOBS="${OT6_JOBS:-4}"
TESTS="smoke battle_entry battle_break battle_class battle_bp battle_boost battle_hits battle_fold battle_preview battle_codex battle_c battle_fontrestore battle_dlgmenu hud_stability visual_f1 visual_f2"
