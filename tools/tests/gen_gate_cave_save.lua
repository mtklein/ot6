...
H.run({ maxFrames = 200000 }, {
  ...
  H.call(function()
    H.assertEq((H.readByte(0x0201) & 0x80) ~= 0, true,
      "menu-flags $0201 bit7 SET -- save legal on the save tile")
    -- codex witnesses in BOTH candidate source pages (the gen_n024
    -- rationale: this chain Continued from slot 3, so the active page is
    -- $0800 and SaveAs to slot 3 is a no-op copy)
