...
-- contract (issue #31, the #25 discipline): boot the minted boundary state,
-- PERTURB one contract-checked fact (bench SABIN -- zero his $1850 party
-- nibble), and assert the exit contract.  The expected outcome is a FAILURE
-- that names the party-size count and SABIN's membership; this probe
-- passing would mean the contract asserts nothing.  NOT a suite test; run
-- by hand, expect exit 1, grep the log for the named diffs.
