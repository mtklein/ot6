...
H.run({ maxFrames = 90000 }, {
  ...
  H.openChest{ stand = { 8, 38 }, face = "up", bit = 94,
               what = "Break Blade",
               nav = { playBattles = "flee", careThreshold = 0.85, healPercent = 45 } },
  ...
  H.navTo(26, 52, { maxFrames = 9000, playBattles = "flee", careThreshold = 0.85, healPercent = 45 }),
  ...
  H.navTo(25, 52, { maxFrames = 15000, playBattles = "flee", careThreshold = 0.85, healPercent = 45 }),
