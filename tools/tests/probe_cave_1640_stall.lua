-- probe_cave_1640_stall.lua -- replays from sfigaro_escape (world map),
-- crosses to the cave, walks toward warp A, and dumps state as soon as
-- control is lost: field cells, world-module cells, the $3BF4 battle-HP
-- words battleLoadStarted() reads, the event PC, and screenshots.
