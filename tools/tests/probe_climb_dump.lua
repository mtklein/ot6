...
-- the bridge-room shaft prop tables plus a door-walled all-z BFS to
-- (30,34), to determine whether there is a non-warp route to the (30,34)
-- door or whether (30,41) is unavoidable.  Read-only measurement;
-- generates nothing.
