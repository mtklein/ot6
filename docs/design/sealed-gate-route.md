...
- If GAU is available (he is, on this chain), he tags along and refuses to
  board at 332 (10,10)/(11,10): "He hates ships. We must…leave him behind!" —
  **`char_party GAU, 0` and `switch $02FB=0`** (`_cbcb74/_cbcbde`,
  `:67905/:67978`).
